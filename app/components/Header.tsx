	...
	return (
		<div className='relative'>
			<div className='relative z-20 flex justify-between items-center h-[104px] px-4 pt-4 max-w-[1175px] w-full mx-auto sm:h-[140px] sm:pt-8'>
				...
				<div className='w-[68px] h-14 md:hidden '>
					<MobileMenuLogo />
				</div>
			</div>
			<div className='border-2 border-red-500 flex items-end w-full mt-[-90px] z-1 h-[265px] xxs:h-[317px] xs:h-[355px] sm:h-[400px] md:h-auto'>
				<Slider />
			</div>
		</div>
	);
